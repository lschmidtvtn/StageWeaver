 ...
 * This file demonstrates how to integrate Stageweaver with a web frontend
 */

// For React/Vue/Angular applications
export class StageweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new StageweaverClient(provider, contractAddress);
