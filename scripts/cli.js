...
const contractABI = require("../artifacts/contracts/Stageweaver.sol/Stageweaver.json").abi;

program
    .name("stageweaver-cli")
    .description("CLI tool for Stageweaver smart contract")
    .version("1.0.0");
